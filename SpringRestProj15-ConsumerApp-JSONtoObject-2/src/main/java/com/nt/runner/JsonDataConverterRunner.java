...
public class JsonDataConverterRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		//Prepare ServiceUrl
		String serviceUrl="http://localhost:2020/SpringRestProj15-ProviderApp-JSONtoObject-2/politican/api/find/{id}";
		//Invoke resr api
		...
		politician.setRetirementAge(politician.getAge()+20.f);
